...
class PlayersPanel {
    ...
    async startFirstTurn() {
        ...
        // Don't call startTurn() here - that would add income on initial load
        // Just fire the listeners to initialize snapshots
    ...
    async handleTurnEndedFor(endedIndex) {
        ...
        await nextPanel.startTurn(true); // performRepairs=true when advancing turns
